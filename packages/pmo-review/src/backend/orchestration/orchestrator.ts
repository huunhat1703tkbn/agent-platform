...
function instructionsText(): string {
  return [
    ...
    'writing anything. Issuing is NEVER a direct write you perform — it ALWAYS goes through this',
    'confirmation gate. When a report issuance is pending, tell the user to review the approval card.',
    '',
